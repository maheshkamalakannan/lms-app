...
<div id="rightdata" ng-controller="leavesummaryController">
  ...
  <div class="leavesummaryContent">
		      ...
		      <div class="leavesummarygridStyle" style="margin-top: -10px;" ng-grid="gridOptions2"></div>
		      <div class="applyleavegridStyle" style="margin-top:5px; margin-left:180px;" ng-grid="gridOptions1"></div>
	       </div>
  </div>
</div>
