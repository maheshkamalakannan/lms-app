	  ...
	  <div id="topcontent" style="margin-bottom:2px;">
	         ...
	         <div class="signout">
	          ...
	          <div id="search" ng-model="ngsearch" ng-show="ngsearch">
	            ...
	            <span class="error" style="width: 20%;margin-top:-5px; margin-left:120px;" ng-show="search && deleteuser.emailSearch.$error.required">Email Address is Required.</span> 
	            <span class="error" style="width: 20%;margin-top:-5px; margin-left:120px;" ng-show="search && deleteuser.emailSearch.$error.email">Email Address is invalid.</span>
